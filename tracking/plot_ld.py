...
def plot_avg_distance(json_file):
    ...
    plt.xlabel("Proportion of nodes visited until lowest distance was found")
...
if __name__ == "__main__":
    plot_avg_distance("../build/data/_latest_distribution.json")  # Replace with actual JSON file path
